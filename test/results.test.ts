...
import { fail, isFail, isHandlerResult, isStay, isTransitionTo, stay, transitionTo } from "../src/results.js"
...
describe("stay", () => {
  it("carries values", () => {
    expect(stay({ attempt: 2 })).toEqual({ kind: "stay", values: { attempt: 2 } })
  })
